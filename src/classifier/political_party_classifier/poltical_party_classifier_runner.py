...
training_feature_sets = [OurFeatureSet.build(speech, known_clas=party, stop_words=stop_words) for speech, party in training_data]

# Train the classifier
classifier = OurAbstractClassifier.train(training_feature_sets)

# Test the classifier on a new speech
test_speech = "Your test speech goes here..."
test_feature_set = OurFeatureSet.build(test_speech, stop_words=stop_words)
